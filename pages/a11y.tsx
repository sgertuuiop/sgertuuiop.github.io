  ...
  return (
    <>
      ...
      >
        ...
        <div className="cr-paragraph">
          <p>
            In addition, this website also conforms with some criteria of WCAG
            2.1 Level AAA, specifically:
          </p>
          <ul>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                images of text has a contrast ratio of at least 7:1 for body
                text, and 4.5:1 for large text. (Criterion 1.4.6)
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <b>Location</b>: Information about the user&apos;s location
